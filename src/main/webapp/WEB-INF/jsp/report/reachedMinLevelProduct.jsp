	...
	<section class="content">
		<div class="box box-body">
			<table id="user-table"  style="cursor:pointer;"
				...
				<tbody>
					<c:forEach items="${reachedMinLevelProduct.result}" var="re">
						<tr>
...
<script>
	var reachedMinLevelProduct = "";
	reachedMinLevelProduct = ${reachedMinLevelProduct.resultString};
	console.log(reachedMinLevelProduct);
