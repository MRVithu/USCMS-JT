	...
	<section class="content">
		...
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title">Last 14 days Purchase's Amount  Vs Qty</h3>
...
<script>
	...
	purAmountVsQty = ${purAmountVsQty.resultString};
	console.log(purAmountVsQty);
	...
	$.each( purAmountVsQty.result, function(i, data) {
